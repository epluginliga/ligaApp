...
import { Diamont, DiamontDown } from '../../icons/Diamont';

export type Carrocel = {
   evento: EventosPayload
}
export function Carrocel({ evento }: Carrocel) {
      ...
      return (
         <>
            <VStack position='relative' overflow='hidden' borderRadius={10}>
               <Imagem style={{position: "relative"}} source={{ uri: item.path_imagem }} >
