...
function Tabs({ setStepAtual, stepAtual }: TabsProps) {
   return (
      <HStack
         ...
         left={0}
      >
         <TouchableOpacity onPress={() => setStepAtual(1)} activeOpacity={0.7}>
            <VStack
               paddingVertical="sm"
               ...
               backgroundColor={
                  stepAtual === 1 ? 'buttonPrimaryBackground' : 'botao_default'
               }
            >
         ...
         <TouchableOpacity onPress={() => setStepAtual(2)} activeOpacity={0.7}>
            <VStack
               paddingVertical="sm"
               paddingHorizontal="lg"
               ...
               backgroundColor={
                  stepAtual === 2 ? 'buttonPrimaryBackground' : 'botao_default'
               }
            >
               <Text color="white" variant="header3">
                  Eventos passados
