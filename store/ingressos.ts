export const data = {
   ...
   "first_page_url": "http://localhost/liga/public/api/evento/ingresso/ingressos-comprados?page=1",
   "from": 1,
   "last_page": 1,
   "last_page_url": "http://localhost/liga/public/api/evento/ingresso/ingressos-comprados?page=1",
   "links": [
      {
         "url": null,
      ...
      {
         "url": "http://localhost/liga/public/api/evento/ingresso/ingressos-comprados?page=1",
         "label": "1",
         "active": true
      },
      {
   ...
   "next_page_url": null,
   "path": "http://localhost/liga/public/api/evento/ingresso/ingressos-comprados",
   "per_page": 20,
   "prev_page_url": null,
   "to": 1,
   "total": 1
